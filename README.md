Flast Card + React Native app example
===

This is an example [Udacity Flash Card] backed [React Native](https://facebook.github.io/react-native/) app for the flash card.
